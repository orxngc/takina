...
class Fun(commands.Cog):
    ...
    async def eight_ball(self, ctx: commands.Context, *, question: str = None):
        ...
        if not question:
            await ctx.reply("You need to ask a question for the 8ball!", mention_author=False)
            return
...
class FunSlash(commands.Cog):
    ...
    async def slash_eight_ball(self, interaction: nextcord.Interaction, *, question: str = SlashOption(
